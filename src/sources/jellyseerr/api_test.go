...
func TestGetMedia(t *testing.T) {
	...
	t.Run("get movie", func(t *testing.T) {
		media, err := j.GetMedia(-1, "", "") // civil war
		if err != nil {
			t.Fatal(err)
		}
...
func TestGetMovieTV(t *testing.T) {
	t.Run("get movie", func(t *testing.T) {
		media, err := j.GetMovie(929590) // civil war
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("get tv show", func(t *testing.T) {
		media, err := j.GetTV(2316) // the office
		if err != nil {
			t.Fatal(err)
		}
...
func TestGetIframeData(t *testing.T) {
	...
	t.Run("get iframe requests data", func(t *testing.T) {
		iframeData, err := j.GetIframeData(-1, "", "", 0, false)
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("get iframe media data", func(t *testing.T) {
		iframeData, err := j.GetIframeData(-1, "", "", 0, true)
		if err != nil {
			t.Fatal(err)
		}
